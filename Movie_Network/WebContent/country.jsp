...
<!--/main-header-->
									...
									<li>
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<li><a href="genre.jsp">亚洲</a></li>
												<li><a href="genre.jsp">法国</a></li>
												<li><a href="genre.jsp">中国台湾</a></li>
												<li><a href="genre.jsp">美国</a></li>
											</ul>
										</div>
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<li><a href="genre.jsp">中国</a></li>
												<li><a href="genre.jsp">中国香港</a></li>
												<li><a href="genre.jsp">日本</a></li>
												<li><a href="genre.jsp">泰国</a></li>
											</ul>
										</div>
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<li><a href="genre.jsp">欧洲</a></li>
												<li><a href="genre.jsp">印度</a></li>
												<li><a href="genre.jsp">韩国</a></li>
												<li><a href="genre.jsp">英国</a></li>
											</ul>
										</div>
 ...
 <!--//main-header-->
			...
			<!--/content-inner-section-->
				<div class="w3_content_agilleinfo_inner">
					<div class="agile_featured_movies">
						<!--/comedy-movies-->
					<h3 class="agile_w3_title hor-t">亚洲<span>电影</span> </h3>
			...
			<!--//comedy-movies-->
					<!--/tv-movies-->
					<h3 class="agile_w3_title">欧洲<span>电影</span> </h3>
					 <div class="wthree_agile-requested-movies tv-movies">
										<div class="col-md-2 w3l-movie-gride-agile requested-movies">
			...
			<!--//tv-movies-->
				 <h3 class="agile_w3_title">印度 <span>电影</span> </h3>
				<!--/requested-movies-->
				...
				<!--//requested-movies-->
					  <div class="blog-pagenat-wthree">
								...
								<!--//requested-movies-->
				  <h3 class="agile_w3_title"> 美国 <span>电影</span></h3>
			<!--/movies-->				
