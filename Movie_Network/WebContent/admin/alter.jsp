		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">修改</h2>
								 	...
								 	<div class="cBody">
										<form class="layui-form" action="">
											...
											<table id="customList" border="1" width="90%" align="center">
												...
												<tbody>
													<c:forEach var = "item" items = "${sessionScope.operatefilmform_alter}">
													<tr>
														...
														<td>
															<a href="alterFilm?index=${item.f_id }&type=first" class="layui-btn layui-btn-xs" onclick="delCustomList(this)">修改</a>
														</td>
													</tr>
													</c:forEach>
													<tr>
														...
														<td>
															<a class="layui-btn layui-btn-xs" onclick="delCustomList(this)">修改</a>
														</td>
													</tr>
												</tbody>
