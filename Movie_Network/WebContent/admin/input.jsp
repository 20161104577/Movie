						...
						<div class="forms-main_agileits">
								...
								<div class="graph-form agile_info_shadow">
								 <h3 class="w3_inner_tittle two">Basic Form </h3>
										<div class="form-body">
											<form action="FilmInput" method="post"> 
												...
												<div class="form-group"> 
													<label for="exampleInputPassword1">添加电影名字</label> <input type="Text" name="filemname" class="form-control" id="exampleInputFilename" placeholder="">
												 </div>
												<div class="form-group"> 
													<label for="exampleInputDataTime">添加上映时间</label><input type="Text" name="year" class="form-control" id="exampleInputYear" placeholder="输入格式为YYYY-MM-DD">  
												</div> 
												<div class="form-group"> 
													<label for="exampleInputPassword1">添加电影简介</label> <input type="Text" name="brief" class="form-control" id="exampleInputBrief" placeholder="">
												 </div>
												 <div class="form-group"> 
													<label for="exampleInputPassword1">添加电影国家</label> <input type="Text" name="country" class="form-control" id="exampleInputCountry" placeholder="">
												 </div>
