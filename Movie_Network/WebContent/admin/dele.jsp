		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">删除</h2>
								 	...
								 	<div class="cBody">
										<form class="layui-form" action="">
											...
											<table id="customList" border="1" width="90%" align="center">
												...
												<tbody>
													<c:forEach var = "item" items = "${sessionScope.operatefilmform_dele}">
													<tr>
														...
														<td>
															<a href="deleteFilm?index=${item.f_id }" class="layui-btn layui-btn-xs" onclick="delCustomList(this)">删除</a>
														</td>
													</tr>
													</c:forEach>
													<tr>
