 ...
 <!--//main-header-->
	...
	<div class="breadcrumb-inner">	
			<ul>
				...
				<li><a href="news-single.jsp">评论</a><i>//</i></li>
				<li>回复</li>
			</ul>
		</div>
	</div>
				...
				<div class="w3_content_agilleinfo_inner">
						<div class="agile_featured_movies">
				            <div class="inner-agile-w3l-part-head">
					            <h3 class="w3l-inner-h-title">电影单</h3>
							</div>
							   <div class="latest-news-agile-info">
								   <div class="col-md-8 latest-news-agile-left-content">
											<div class="single video_agile_player">
															<video  width=100% height=100% controls poster="images/honghaixingdong.jpg">
															  <source src="media/bigbad.mp4" type='video/mp4' >
															</video>
										    </div>
							...
							<div class="media response-info">
								...
								<div class="media-body response-text-right">
									...
									<ul>
										...
										<li><a href="single.jsp"><i class="fa fa-reply" aria-hidden="true"></i> 回复</a></li>
									</ul>
									<div class="media response-info">
										<div class="media-left response-text-left">
											<a href="#">
							...
							<div class="media response-info">
								...
								<div class="clearfix"> </div>
												...
												<div class="agile-info-wthree-box">
													<form>
													   <div class="col-md-6 form-info">
														...
														<input type="text" name="phone" placeholder="你的电话" required="">	
													  </div>
													   <div class="col-md-6 form-info">
														
														<textarea placeholder="讯息" required=""></textarea>
								   ...
								   <h4 class="side-t-w3l-agile">关于最新<span>电影</span></h4>
								      ...
								      <h4 class="side-t-w3l-agile">热门<span>话题</span></h4>
										...
										<h5 class="side-t-w3l-agile">最新 <span>预告片</span></h5>
										<div class="video_agile_player sidebar-player">
												...
												<p class="fexi_header_para"><span class="conjuring_w3">故事梗概<label>:</label></span>Me Before You Official Trailer #2 (2016) - Emilia Clarke, Sam Claflin Movie HD
...
<!-- <script type="text/javascript">
    ...
    var url="F:/电影/惊悚/忌日快乐.mp4";  //电脑上视频文件的绝对路径
